...
<!--                <a href="../control/inicio.php" class="home-icon active-navigation">Inicio</a>-->
                ...
                <div class="content">
                    ...
                    <div class="page-head">
                        <h5 class="uppercase">Índice Gestión</h5>
                    ...
                    if ($totSolicitantes != "" ) {
                        ...
                        <div class="container no-bottom">
                            <div class="container no-bottom">
                                <h4 class="uppercase">Informe de Gestión BDU</h4>
                                ...
                                <div class="column-responsive no-bottom">
                                    <div class="one-half-responsive">
                                        <div class="notification-box red-box">
                                            <h4>LISTA ESPERA:   <?php  echo count($listaEspera);?> </h4>
                                            <div class="clear"></div>
                                        </div>    
                                        <div class="notification-box blue-box">
                                            <h4>CANTIDAD POSTULANTES: <?php echo count($lista_post_sin_evm) ?></h4>
                                            <div class="clear"></div>
                                        </div>
                                    </div>
                                    <div class="one-half-responsive">       
                                        <div class="notification-box red-box">
                                            <h4>CANTIDAD SOLICITANTES: <?php echo $totSolicitantes ?> </h4>
                                            <div class="clear"></div>
                                        </div>   
                                        <div class="notification-box blue-box">
                                            <h4>CANTIDAD DEMANDA: <?php echo  $demanda?></h4>
                        ...
                        <?php
                    } else { // MENSAJE ERROR CONEXION A BD
