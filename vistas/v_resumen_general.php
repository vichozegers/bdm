...
<!--                <a href="../control/inicio.php" class="home-icon active-navigation">Inicio</a>-->
                ...
                <div class="content">
                    ...
                    <div class="page-head">
                        <h5 class="uppercase">Resumen General</h5>
                    ...
                    if ($residentes_hogarcristo!= "" && $egresados_hogarcristo !="" && $fallecidos_hogarcristo!="" && $totResComunidad!="") {  ?>
                      
                        <div class="container no-bottom">
                            <div class="container no-bottom">
                                <h4 class="uppercase">Resumen General BDU</h4>
                                ...
                                <div class="column-responsive no-bottom">
                                    <div class="one-half-responsive">
                                        <div class="notification-box red-box">
                                            <h4>RESIDENTES COMUNIDAD:   <?php echo $totResComunidad?> </h4> 
                                            <div class="clear"></div>
                                        </div>    
                                        <div class="notification-box green-box">
                                            <h4>RESIDENTES H.CRISTO: <?php echo count($residentes_hogarcristo)?></h4>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="notification-box green-box">
                                            <h4>EGRESADOS HC: <?php echo count($egresados_hogarcristo) ?></h4>
                                            <div class="clear"></div>
                                        </div> 
                                    </div>
                                    <div class="one-half-responsive">       
                                        <div class="notification-box green-box">
                                            <h4>FALLECIDOS HC: <?php echo count($fallecidos_hogarcristo)?></h4>
                                            <div class="clear"></div>
                                        </div> 
                                        <div class="notification-box red-box">
                                            <h4>TOTAL RESIDENTES: <?php echo $restotales ?> </h4>
                                            <div class="clear"></div>
                                        </div>   
                                    </div>
                                </div> 
