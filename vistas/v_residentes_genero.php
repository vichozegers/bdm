...
<!--                <a href="../control/inicio.php" class="home-icon active-navigation">Inicio</a>-->
                    ...
                    <a href="../control/residentes_genero" class="gallery-icon">Resumen AM</a>
                ...
                <div class="content">
                    ...
                    <div class="page-head">
                        <h5 class="uppercase">Resumen por Genero</h5>
                        <em>Información BDU</em>
                    </div>
                    <div class="decoration"></div>

                    <!-- CODIGO PHP -QUERYS SQL-->

                    <?php
                           //VALOR HOMBRE APODERADO               //VALOR MUJERES APODERADO
                    if ( $registroHombreSinApoderado == ""  or $registroMujerSinApoderado ==""  ) {
                        ?>
                        <!-- FIN QUERY SQL -->
                        <div class="container no-bottom">
                            ...
                            <div class="container no-bottom">
                                <h4 class="uppercase">Resumen por Genero BDU</h4>
                                <p>Información obtenida directamente del Sistema BDU</p>

                                <div class="column-responsive no-bottom">
                                    <h4 class="uppercase">RESIDENTES FEMENINOS</h4>
                                    <div class="one-half-responsive">
                                        <div class="notification-box blue-box">
                                            <h4>CON APODERADO: <?php echo $totResConApoderadoMujer?> </h4>
                                            <div class="clear"></div>
                                        </div>    
                                        <div class="notification-box blue-box">
                                            <h4>SIN APODERADO: <?php echo $totResSinApoderadoMujer?></h4>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="notification-box red-box">
                                            <h4>TOTAL: <?php echo (int) $totResConApoderadoMujer + (int) $totResSinApoderadoMujer  ?> </h4>
                                            <div class="clear"></div>
                                        </div>   
                                        <h4 class="uppercase">RESIDENTES MASCULINOS</h4>
                                        <div class="notification-box blue-box">
                                            <h4>CON APODERADO: <?php echo $totResConApoderadoHombre ?></h4>
                                            <div class="clear"></div>
                                        </div> 
                                    </div>
                                    <div class="one-half-responsive">       
                                        <div class="notification-box blue-box">
                                            <h4>SIN APODERADO:<?php echo $totResSinApoderadoHombre ?></h4>
                                            <div class="clear"></div>
                                        </div> 
                                        <div class="notification-box red-box">
                                            <h4>TOTAL:<?php echo (int)$totResConApoderadoHombre + (int)$totResSinApoderadoHombre; ?> </h4>
                                            <div class="clear"></div>
                                        </div>   
                                    </div>
                                </div> 
